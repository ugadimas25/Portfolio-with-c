...
#warning These settings must be updated first before building and running. Delete this line when done:
        private const string AppClientId = "CwMZrvWtTYs0ykc0";
        private const string ClientSecret = "474e1813b4194b15ac7d61a605e5f1f4";
        private const string OAuthRedirectUrl = @"https://testserver.esri.arcgis.com";
